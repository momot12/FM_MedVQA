...
# from pefomed.datasets.datasets.general.aok_vqa_datasets import AOKVQADataset, AOKVQAEvalDataset, AOKVQAInstructDataset
# from pefomed.datasets.datasets.general.coco_vqa_datasets import COCOVQADataset, COCOVQAEvalDataset, COCOVQAInstructDataset
# from pefomed.datasets.datasets.general.vg_vqa_datasets import VGVQADataset, VGVQAInstructDataset
# from pefomed.datasets.datasets.general.gqa_datasets import GQADataset, GQAEvalDataset, GQAInstructDataset
# from pefomed.datasets.datasets.general.iconqa_datasets import IconQADataset, IconQAEvalDataset, IconQAInstructDataset
# from pefomed.datasets.datasets.general.ocr_datasets import OCRVQADataset, OCRVQAInstructDataset
# from pefomed.datasets.datasets.general.vizwiz_vqa_datasets import VizWizEvalDataset
