"""Computes F1 scores using F1_Bert score, which considers the semantic aspects of the generated text. 
   Customized implementation by us."""
...
# NOTE: choose respective checkpoints, models and dataset. 
