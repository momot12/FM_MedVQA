import os
import torch
from transformers import ViltProcessor, ViltForMaskedLM, ViltForQuestionAnswering, TrainingArguments, Trainer, AutoTokenizer
...
pretrain_lora_ckpt = 'output/vilt-peft/ckpt'
pretrain_lora_name = '2024-11-27-06:29'
pretrain_lora_ckpt = os.path.join(pretrain_lora_ckpt, pretrain_lora_name)
output_dir = 'output/vilt-peft-finetune/ckpt'
# Save the model
